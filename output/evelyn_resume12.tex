...
\clubpenalty=8000      % Strongly discourage club lines
\widowpenalty=8000     % Strongly discourage widow lines
\tolerance=1000          % Be more tolerant of imperfect line breaks to fill space
\setlength{\emergencystretch}{1.5em} % Add some stretchability to lines
...
\begin{document}
\setlength{\pdfpageheight}{15.00in}
