...
\usepackage{needspace} % For preventing page breaks within key sections

% Page breaking settings
\raggedbottom % Allow flexible spacing at the bottom of the page
\interlinepenalty=10000 % Discourage page breaks within paragraphs
\widowpenalty=10000 % Discourage widow lines
\clubpenalty=10000 % Discourage club lines

%----------FONT OPTIONS----------
% Reduced from 11pt to 10pt in the documentclass to save space
...
\setlength{\parsep}{0pt} % Reduce spacing between paragraphs
...
\setlength{\emergencystretch}{3em} % Allow more stretch to avoid bad line breaks
\sloppy % Prefer bad spacing to bad line breaks
